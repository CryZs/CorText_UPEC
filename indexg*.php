...
<html>
    <head>
        ...
        <title>Interface Gestion des Voeux</title>
    ...
    <body>
        ...
        <div class="formContent" id="formContent">
            ...
            <input type="submit" value="Submit" class="btn btn-default"/>
                            ...
                            <div class="list">
                                <input type="checkbox" class="msgCheckbox" name="president" id="VGE"/><label for="VGE">&nbsp;Valéry Giscard d'Estaing</label><br/>
                                <input type="checkbox" class="msgCheckbox" name="president" id="FM"/><label for="FM">&nbsp;François Mitterrand</label><br/>
                                <input type="checkbox" class="msgCheckbox" name="president" id="JC"/><label for="JC">&nbsp;Jacques Chirac</label><br/>
                                <input type="checkbox" class="msgCheckbox" name="president" id="NS"/><label for="NS">&nbsp;Nicolas Sarkozy</label><br/>
                                <input type="checkbox" class="msgCheckbox" name="president" id="FH"/><label for="FH">&nbsp;François Hollande</label><br/>
                            </div>
                ...
                <div class="buttons">
                    <div class="btn btn-default" id="login" onclick="displayLogin()">Se connecter</div>
                    <input type="submit" class="btn btn-default" id="submit" value="Générer" onmouseover="changeClassButton()"/>
                </div>
            </form>
            ...
            <div id="connection">
                <h1>Login</h1><hr/>
                <form class="formLogin" role="form" action="login.php" method="post">
                    <label for="username">Nom d'utilisateur :</label><br/><input type="text" name="username" id="username" required autofocus/>
                    <br/><br/>
                    <label for="password">Mot de passe :</label><br/><input type="password" name="password" id="password" required/>
                    <br/><br/><br/>
